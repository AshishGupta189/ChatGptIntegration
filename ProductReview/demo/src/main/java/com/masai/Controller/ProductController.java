...
public class ProductController {
	...
	public ResponseEntity<String> createProductHandler(@RequestBody ProductDTO product) {
	...
	public ResponseEntity<String> updateProductHandler(@PathVariable("id") Integer id, @RequestBody ProductDTO pro) throws ProductException {
		String	result =simpl.updateProduct(id, pro);
		return new ResponseEntity<String>(result,HttpStatus.OK );
	}
	@DeleteMapping("/products/{id}")
	public ResponseEntity<String> deleteProductHandler(@PathVariable("id") Integer id) throws ProductException {
		String	result =simpl.deleteProduct(id);
		return new ResponseEntity<String>(result,HttpStatus.OK );
	}
	@PostMapping("/products/{productId}/reviews")
	public ResponseEntity<String> createReviewHandler(@PathVariable("productId") Integer productId,@RequestBody ReviewDTO review) throws ProductException, ReviewException {
		String	result =simpl.createReview(productId, review);
		return new ResponseEntity<String>(result,HttpStatus.OK );
	}
	@DeleteMapping("/products/{productId}/reviews/{reviewId}")
	public ResponseEntity<String> deleteReviewHandler(@PathVariable("productId") Integer productId,@PathVariable("reviewId") Integer reviewId) throws ProductException, ReviewException {
		String	result =simpl.deleteReview(productId, reviewId);
		return new ResponseEntity<String>(result,HttpStatus.OK );
	}
	@GetMapping("/products/{productId}/reviews")
	public ResponseEntity<List<Review>> getReviewsforProductHandler(@PathVariable("productId") Integer id) throws ProductException, ReviewException {
